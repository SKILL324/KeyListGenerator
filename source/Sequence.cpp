...
{
	printf("CHAR = 1, NUMBER = 0, MAX = 50, Ex: 100101010010 \n");
	printf("Sequence: ");
...
int Sequence_Validate(char* sequence)
{
	for (int i = 0; i <= sizeof(sequence); i++)
	{
		...
		{
			printf("Invalid sequence. (Type only '0' or '1')\n");
			return 0;
		}
	}
}
void rndCharacter(char* rdChar, enum CASE case_type)
{
	switch (case_type)
	{
	case Lower:
...
int GenerateKeys()
{
	...
	{
		printf("Failed To Create/Write on file.\n");
		return 0;
	}
